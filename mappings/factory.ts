...
import { BlueberryFactory, Pair, Token, Bundle } from '../generated/schema';
...
export function handlePairCreated(event: PairCreated): void {
  let factory = BlueberryFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new BlueberryFactory(FACTORY_ADDRESS);
